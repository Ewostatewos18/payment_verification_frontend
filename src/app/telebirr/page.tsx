    ...
    <div className="min-h-screen w-full bg-white flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-row justify-center items-start p-4 sm:p-6 lg:p-8">
        ...
        <div className="w-full max-w-4xl flex flex-col items-start">
          ...
          <div className="w-full h-auto flex flex-col items-center p-4 sm:p-6 gap-3 relative">
            {/* Back Button */}
            <button
              onClick={() => router.push('/')}
          ...
          <div className="w-full h-auto flex flex-col justify-center items-start p-4 sm:p-6 border-b border-[#8C8C8C] border-opacity-50">
            <div className="w-full flex flex-col sm:flex-row justify-between items-center gap-4 rounded-lg">
              
              {/* Left Content - Responsive */}
              <div className="w-full sm:flex-1 flex flex-col justify-center items-start gap-1">
                
                {/* Title - Responsive */}
                <div className="w-full flex flex-col items-start">
                  <h3 className="w-full font-['Inter'] font-bold text-base sm:text-lg leading-5 text-[#121417]">
                    Telebirr
                  </h3>
                </div>
                ...
                <div className="w-full flex flex-col items-start">
                  <p className="w-full font-['Inter'] font-normal text-sm leading-[21px] text-[#61758A]">
          ...
          <div className="w-full h-auto flex flex-col items-start pb-3">
            <div className="w-full h-auto flex flex-row items-start px-4 gap-4 sm:gap-8 border-b border-[#DBE0E6]">
              <div className="w-full h-12 flex flex-row items-center">
                
                {/* Upload Tab - Responsive */}
                <button
                  onClick={() => setActiveTab('upload')}
                  className={`w-auto min-w-[72px] h-12 flex flex-row justify-center items-center p-1.5 gap-2 ${activeTab === 'upload' ? 'border-b-2 border-[#18181B]' : ''}`}
                >
                ...
                {/* Enter Transaction ID Tab - Responsive */}
                <button
                  onClick={() => setActiveTab('transaction')}
                  className={`w-auto min-w-[159px] h-12 flex flex-row justify-center items-center p-1.5 gap-2 ${activeTab === 'transaction' ? 'border-b-2 border-[#18181B]' : ''}`}
                >
                  <span className="font-['Inter'] font-medium text-sm leading-5 text-[#121417]">
          ...
          <div className="w-full h-auto flex flex-col items-start p-4 sm:p-6">
            ...
            {activeTab === 'upload' ? (
              <>
                ...
                <div 
                  className={`w-full h-auto min-h-[200px] sm:min-h-[249px] flex flex-col items-center py-8 sm:py-14 px-6 sm:px-6 gap-6 border-2 border-dashed border-[#DBE0E6] rounded-lg ${!showCamera && !capturedImageSrc ? 'cursor-pointer' : ''}`}
                ...
                <div className="w-full h-auto flex mt-6 flex-row justify-center items-start">
              ...
              <div className="w-full h-auto flex flex-col items-start">
                ...
                <div className="w-full h-auto flex flex-row justify-center items-start">
                  <div className="w-full max-w-md h-auto flex flex-row justify-center items-center py-3">
