...
export default function CBEPage() {
  ...
  const handleCBEVerify = async (
    ...
    if (inputMethod === 'text') {
      apiEndpoint = `${BACKEND_BASE_URL}/verify_cbe_payment`;
      ...
      formData.append('image_file', fileToUpload!, `image_cbe.png`); // '!' asserts non-null
      formData.append('account_number_input', accountNumber);
      apiEndpoint = `${BACKEND_BASE_URL}/verify_cbe_payment_from_image`;
      requestBody = formData;
    } else {
      throw new Error('Invalid input method.');
    }

    console.log('--- Sending Request (CBE) ---');
    ...
    console.log('--- Received Response (CBE) ---');
