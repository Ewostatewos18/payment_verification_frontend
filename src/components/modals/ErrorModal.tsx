        ...
        <div className="w-[500px] h-[120px] flex flex-col items-center gap-4 p-6">
          ...
          <div className="w-[300px] h-10 flex flex-row items-center gap-4">
            ...
            {errorInfo.showRetry && onRetry && (
              <div className="w-[100px] h-10 flex flex-row justify-center items-center px-4 py-2 gap-2 bg-[#FF383C] shadow-[0px_1px_3px_rgba(0,0,0,0.1),0px_1px_2px_rgba(0,0,0,0.06)] rounded-md">
                <button
                  onClick={onRetry}
                  className="w-[68px] h-5 font-['Inter'] font-medium text-sm leading-5 flex items-center text-[#FAFAFA]"
                >
                  Retry
                </button>
              </div>
